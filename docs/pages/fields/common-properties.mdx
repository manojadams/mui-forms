...
| htmlProps    | Object                            | None          | It is used for setting native html attributes to basic form controls like text_field, select, number, password, email etc. <br /> Example os such attributes like `step`, `min`, `max` for displayType number |
