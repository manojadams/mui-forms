...
| Name              | Description                                                                                                                                                                                                     |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Name of metaform  | This is the name of the metaforms which must be given as an input property while using metaform. e.g.: `<MaterialForms-mui name="Basic details" schema={schema} />`. <br/> Here the name is **`Basic details`** |
