...
jest.mock("../../components/InputControl", () => (props) => <div data-testid="input-control">{props.form.displayName}</div>);
jest.mock("../../components/SelectControl", () => (props) => <div data-testid="select-control">{props.form.displayName}</div>);
jest.mock("../../components/CheckboxControl", () => (props) => <div data-testid="checkbox-control">{props.form.displayName}</div>);
