...
describe("RadioControl", () => {
    ...
    it("should render radio buttons correctly", () => {
        ...
        expect((getByLabelText("Male") as HTMLInputElement).checked).toBe(true);
    });
    ...
    it("should render as disabled when isDisabled is true", () => {
        ...
        expect((getByLabelText("Male") as HTMLInputElement).disabled).toBe(true);
        expect((getByLabelText("Female") as HTMLInputElement).disabled).toBe(true);
    });
});
