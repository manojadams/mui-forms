...
describe("CheckboxControl", () => {
    ...
    it("should render correctly with options", () => {
        ...
        expect((getByLabelText("Coding") as HTMLInputElement).checked).toBe(true);
    ...
    it("should disable checkboxes when isDisabled is true", () => {
        ...
        expect((getByLabelText("Coding") as HTMLInputElement).disabled).toBe(true);
        expect((getByLabelText("Reading") as HTMLInputElement).disabled).toBe(true);
    });
});
